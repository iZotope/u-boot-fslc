...
enum {
	...
	MX6_PAD_SD2_RESET__USDHC2_RESET				= IOMUX_PAD(0x0584, 0x027C, 0, 0x0000, 0, 0),
	MX6_PAD_SD2_RESET__GPIO_4_27				= IOMUX_PAD(0x0584, 0x027C, 5, 0x0000, 0, 0),
	...
	MX6_PAD_EPDC_SDCLK__GPIO_1_23				= IOMUX_PAD(0x0400, 0x0110, 5, 0x000, 0, 0),

	MX6_PAD_EPDC_D0__ECSPI4_MOSI				= IOMUX_PAD(0x380, 0x090, 1, 0x6D8, 0, 0),
	MX6_PAD_EPDC_D1__ECSPI4_MISO				= IOMUX_PAD(0x384, 0x094, 1, 0x6D4, 0, 0),
	MX6_PAD_EPDC_D3__ECSPI4_SCLK				= IOMUX_PAD(0x3A4, 0x0B4, 1, 0x6D0, 0, 0),
	MX6_PAD_EPDC_D2__GPIO_1_9				= IOMUX_PAD(0x3A0, 0x0B0, 5, 0x000, 0, 0),
	...
	MX6_PAD_LCD1_VSYNC__GPIO2_IO_18			= IOMUX_PAD(0x0524, 0x021C, 5, 0x0000, 0, 0),
	MX6_PAD_LCD1_RESET__GPIO2_IO_19         = IOMUX_PAD(0x0520, 0x0218, 5, 0x0000, 0, 0)
};
